...
class Users_set extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        // Cek apakah pengguna memiliki akses SUPERUSER, jika tidak, arahkan ke halaman utama
        $list_access = array(SUPERUSER);
        if (!in_array($this->session->userdata('uroleid'), $list_access)) {
            redirect('manage');
        }
        
        // Memuat model Users_model dan helper form serta URL
    ...
    public function index($offset = NULL) {
        ...
        // Mendapatkan parameter dari URL (filter)
    ...
    public function add($id = NULL) {
        ...
        // Validasi form untuk menambahkan pengguna baru
        ...
        if ($_POST AND $this->form_validation->run() == TRUE) {
            ...
            // Upload gambar pengguna jika ada
    ...
    public function delete($id = NULL) {
        // Cek apakah pengguna memiliki akses SUPERUSER
