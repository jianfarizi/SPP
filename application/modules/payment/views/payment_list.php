            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <!-- Tombol untuk menambah data pembayaran -->
                        <a href="<?php echo site_url('manage/payment/add') ?>" class="btn btn-sm btn-success"><i
                                class="fa fa-plus"></i> Tambah</a>

                        <div class="box-tools">
                            <!-- Form pencarian data pembayaran -->
                            <?php echo form_open(current_url(), array('class' => 'form-horizontal', 'method' => 'get')) ?>
                            <div class="input-group input-group-sm" style="width: 250px;">
                                <input type="text" id="field" autofocus name="n"
                                    <?php echo (isset($f['n'])) ? 'placeholder="'.$f['n'].'"' : 'placeholder="POS/Nama Pembayaran"' ?>
                                    class="form-control">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- Tombol untuk mengatur tarif pembayaran bulanan -->
                                        ...
                                        <?php } else { ?>
                                        <!-- Tombol untuk mengatur tarif pembayaran bebas -->
                                        <a data-toggle="tooltip" data-placement="top" title="Ubah"
                                            class="btn btn-primary btn-xs"
                                    ...
                                    <td>
                                        <!-- Tombol untuk mengedit data pembayaran -->
                                        <a href="<?php echo site_url('manage/payment/edit/' . $row['payment_id']) ?>"
                                            class="btn btn-xs btn-success" data-toggle="tooltip" title="Edit"><i
