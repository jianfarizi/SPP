            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <!-- Tombol untuk menambah data kelas -->
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal"
                            data-target="#addClass"><i class="fa fa-plus"></i> Tambah</button>
                        ...
                        <div class="box-tools">
                            ...
                            <div class="input-group input-group-sm" style="width: 250px;">
                                <input type="text" id="field" autofocus name="n"
                                    <?php echo (isset($f['n'])) ? 'placeholder="'.$f['n'].'"' : 'placeholder="Nama Kelas"' ?>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- Tombol untuk mengedit data kelas -->
                                        <a href="<?php echo site_url('manage/class/edit/' . $row['class_id']) ?>"
                                            class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"><i
                                                class="fa fa-edit"></i></a>

                                        <!-- Tombol untuk menghapus data kelas dengan konfirmasi modal -->
                                        <a href="#delModal<?php echo $row['class_id']; ?>" data-toggle="modal"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <!-- Form untuk menghapus data kelas -->
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- Tombol untuk menambah baris input kelas -->
                <h6><a href="#" class="btn btn-xs btn-success" id="addScnt_class"><i class="fa fa-plus"></i><b> Tambah
                            Baris</b></a></h6>
            </div>
            <div class="modal-footer">
...
<!-- Script untuk menambah dan menghapus baris input kelas -->
<script>
$(function() {
    var scntDiv = $('#p_scents_class');
    var i = $('#p_scents_class p').size() + 1;

    // Fungsi untuk menambah baris input kelas
    $("#addScnt_class").click(function() {
        $('<p><label>Nama Kelas</label><input required type="text" name="class_name[]" class="form-control" placeholder="Contoh: X (A)"><a href="#" class="btn btn-xs btn-danger remScnt_class">Hapus Baris</a></p>')
            .appendTo(scntDiv);
        i++;
        return false;
    });

    // Fungsi untuk menghapus baris input kelas
