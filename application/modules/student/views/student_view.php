                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 pull-left">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <img src="<?php echo upload_url('student/'.$student['student_img']) ?>"
                                    ...
                                    <table class="table table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Jenis Kelamin</td>
                                                <td>:</td>
                                                <td><?php echo ($student['student_gender']=='L')? 'Laki-laki' : 'Perempuan' ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Tempat, Tanggal Lahir</td>
                                                <td>:</td>
                                                <td><?php echo $student['student_born_place'].', '. pretty_date($student['student_born_date'],'d F Y',false) ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Hobi</td>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="<?php echo site_url('manage/student/edit/' . $student['student_id']) ?>"
                                        class="btn btn-success">
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                    <a href="#delModal<?php echo $student['student_id']; ?>" data-toggle="modal"
                                        class="btn btn-danger"><i class="fa fa-trash" data-toggle="tooltip"
