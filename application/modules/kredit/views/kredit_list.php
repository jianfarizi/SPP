                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal"
                            data-target="#addKredit"><i class="fa fa-plus"></i> Tambah</button>
                        ...
                        <div class="box-tools">
                            ...
                            <div class="input-group input-group-sm" style="width: 250px;">
                                <input type="text" id="field" autofocus name="n"
                                    <?php echo (isset($f['n'])) ? 'placeholder="'.$f['n'].'"' : 'placeholder="Keterangan Pengeluaran"' ?>
                    ...
                    <div class="box-body table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
								// Menampilkan data jika tidak kosong
								if (!empty($kredit)) {
									$i = 1;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- Tombol Edit -->
                                        <a href="<?php echo site_url('manage/kredit/edit/' . $row['kredit_id']) ?>"
                                            class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"><i
                                                class="fa fa-edit"></i></a>

                                        <!-- Tombol Hapus dengan konfirmasi -->
                                        <a href="#delModal<?php echo $row['kredit_id']; ?>" data-toggle="modal"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="hidden" name="delName"
                                                    value="<?php echo $row['kredit_desc']; ?>">
                ...
                <div id="p_scents_kredit">
                    <div class="form-group">
                        ...
                        <div class="input-group date" data-date="" data-date-format="yyyy-mm-dd">
                            ...
                            <input class="form-control" required="" type="text" name="kredit_date"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" required="" name="kredit_desc[]" class="form-control"
                                placeholder="Keterangan Pengeluaran">
                        </div>
                        <div class="col-md-6">
                            <label>Jumlah Rupiah *</label>
                            <input type="number" id="kredit" required="" name="kredit_value[]" class="form-control"
                                placeholder="Jumlah" onfocus="unformatRupiah(this)" onblur="formatRupiah(this);">
                        </div>
                    </div>
                </div>
                <h6><a href="#" class="btn btn-xs btn-success" id="addScnt_kredit"><i class="fa fa-plus"></i><b> Tambah
                            Baris</b></a></h6>
            </div>
            <div class="modal-footer">
