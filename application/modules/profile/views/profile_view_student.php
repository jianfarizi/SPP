<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('student') ?>"><i class="fa fa-th"></i> Beranda</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    ...
                                    <img src="<?php echo upload_url('student/'.$student['student_img']) ?>"
                                        class="img-responsive avatar" alt="Gambar Profil Siswa">
                                    <?php } else { ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="<?php echo site_url('student/profile/cpw'); ?>" class="btn btn-warning">
                                        <i class="fa fa-refresh"></i> Ganti Password
                                    </a>
                                </div>
                            </div>
                            <!-- /.box-body -->
