            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <!-- Button untuk membuka modal tambah debit -->
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal"
                            data-target="#addDebit">
                        ...
                        <div class="box-tools">
                            ...
                            <div class="input-group input-group-sm" style="width: 250px;">
                                <input type="text" id="field" autofocus name="n"
                                    <?php echo (isset($f['n'])) ? 'placeholder="'.$f['n'].'"' : 'placeholder="Keterangan Penerimaan"' ?>
                    ...
                    <div class="box-body table-responsive">
                        <!-- Tabel untuk menampilkan data debit -->
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- Tombol edit debit -->
                                        <a href="<?php echo site_url('manage/debit/edit/' . $row['debit_id']) ?>"
                                            class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </a>

                                        <!-- Tombol hapus dengan konfirmasi -->
                                        <a href="#delModal<?php echo $row['debit_id']; ?>" data-toggle="modal"
                ...
                <div id="p_scents_debit">
                    <div class="form-group">
                        ...
                        <div class="input-group date" data-date="" data-date-format="yyyy-mm-dd">
                            ...
                            <input class="form-control" required type="text" name="debit_date"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" required name="debit_desc[]" class="form-control"
                                placeholder="Keterangan Penerimaan">
                        </div>
                        <div class="col-md-6">
                            <label>Jumlah Rupiah *</label>
                            <input type="number" required name="debit_value[]" class="form-control" placeholder="Jumlah"
                                onfocus="unformatRupiah(this)" onblur="formatRupiah(this);">
                        </div>
                    </div>
                </div>
                <h6>
                    <a href="#" class="btn btn-xs btn-success" id="addScnt_debit">
                        <i class="fa fa-plus"></i><b> Tambah Baris</b>
                    </a>
                </h6>
            </div>
            <div class="modal-footer">
