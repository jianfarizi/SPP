 ...
 * Model Log_trx_model
 *
 * Model ini menangani operasi CRUD (Create, Read, Update, Delete) untuk tabel log_trx.
 * 
 * @package     Arca CMS
 * @subpackage  Models
 * @category    Models
...
class Log_trx_model extends CI_Model {
     ...
     *
     * @param array $params Parameter pencarian dan batasan data
     * @return array|bool Data log transaksi yang sesuai dengan parameter
     */
    ...
    /**
     * Menambahkan atau memperbarui data log_trx
     *
     * @param array $data Data yang akan dimasukkan atau diperbarui
     * @return int|bool ID dari log_trx yang ditambahkan atau diperbarui, atau FALSE jika gagal
     */
    ...
    /**
     * Menghapus data log_trx berdasarkan ID
     *
     * @param int $id ID dari log_trx yang akan dihapus
     */
    function delete($id) {
    ...
    /**
     * Menghapus data log_trx berdasarkan parameter tertentu
     *
     * @param array $params Parameter pencarian untuk menghapus data
     */
