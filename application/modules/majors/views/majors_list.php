            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <!-- Tombol untuk menambah program keahlian -->
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal"
                            data-target="#addMajors">
                        ...
                        <div class="box-tools">
                            ...
                            <div class="input-group input-group-sm" style="width: 250px;">
                                <input type="text" id="field" autofocus name="n"
                                    <?php echo (isset($f['n'])) ? 'placeholder="'.$f['n'].'"' : 'placeholder="Nama Program Keahlian"' ?>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- Tombol Edit untuk setiap program keahlian -->
                                        <a href="<?php echo site_url('manage/majors/edit/' . $row['majors_id']) ?>"
                                            class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </a>

                                        <!-- Tombol Hapus untuk setiap program keahlian -->
                                        <a href="#delModal<?php echo $row['majors_id']; ?>" data-toggle="modal"
...
<!-- Modal untuk menambah program keahlian -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="p_scents_majors">
                    <!-- Input baris awal untuk program keahlian -->
                    <div class="row">
                        <div class="col-md-6">
                            <label>Nama Program Keahlian</label>
                            <input type="text" required name="majors_name[]" class="form-control"
                                placeholder="Contoh: Rekayasa Perangkat Lunak">
                        </div>
                        <div class="col-md-6">
                            <label>Singkatan</label>
                            <input type="text" required name="majors_short_name[]" class="form-control"
                                placeholder="Contoh: RPL">
                        </div>
                    </div>
                </div>
                <!-- Tombol untuk menambah baris input -->
                <h6><a href="#" class="btn btn-xs btn-success" id="addScnt_majors"><i class="fa fa-plus"></i><b> Tambah
                            Baris</b></a></h6>
            </div>
            <div class="modal-footer">
