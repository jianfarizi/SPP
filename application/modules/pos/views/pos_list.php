            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <!-- Tombol untuk Menambahkan POS Baru -->
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addPos">
                        ...
                        <div class="box-tools">
                            ...
                            <div class="input-group input-group-sm" style="width: 250px;">
                                <input type="text" id="field" autofocus name="n"
                                    <?php echo (isset($f['n'])) ? 'placeholder="'.$f['n'].'"' : 'placeholder="Nama POS"' ?>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url('manage/pos/edit/' . $row['pos_id']) ?>"
                                            class="btn btn-xs btn-success" data-toggle="tooltip" title="Edit">
                ...
                <div id="p_scents_pos">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" required="" name="pos_name[]" class="form-control"
                                placeholder="Contoh: SPP">
                        </div>
                        <div class="col-md-6">
                            <label>Keterangan</label>
                            <input type="text" required="" name="pos_description[]" class="form-control"
                                placeholder="Contoh: Sumbangan Pendidikan">
                        </div>
                    </div>
                </div>
                <!-- Tombol untuk Menambah Baris Form -->
                <h6>
                    <a href="#" class="btn btn-xs btn-success" id="addScnt_pos">
